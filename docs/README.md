...
| [windows-runtime-cutover.md](windows-runtime-cutover.md)       | Inventory, detection, source install, one-way cutover, and rollback for shadowing Windows AO installs.                |

...
var schemaNames = map[string]string{
	...
	"ControllersAddDesignContractInvariantRequest":  "AddDesignContractInvariantRequest",
	"ControllersAddDesignContractInvariantResponse": "AddDesignContractInvariantResponse",
	"ControllersDesignContractQuery":                "DesignContractQuery",
	"ControllersGetDesignContractResponse":          "GetDesignContractResponse",
	...
	"ControllersSubmitFindingItem":     "SubmitFindingItem",
	...
	"DomainFindingLedgerSummary": "FindingLedgerSummary",
	"DomainFindingClassCount":    "FindingClassCount",
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/design-contract", id: "getSessionDesignContract", tag: "sessions",
			summary:    "Read the full canonical design contract for one owned PR",
			pathParams: []any{controllers.SessionIDParam{}, controllers.DesignContractQuery{}},
			resps: []respUnit{
				{http.StatusOK, controllers.GetDesignContractResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/design-contract/invariants", id: "addSessionDesignContractInvariant", tag: "sessions",

...
export const metadata: Metadata = {
	...
	description:
		"Open-source platform for running parallel AI coding agents. Spawn Claude Code, Codex, Aider, and more in separate worktrees - all managed from one dashboard.",
	openGraph: {
		type: "website",

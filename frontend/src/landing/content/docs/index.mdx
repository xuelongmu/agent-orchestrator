...
Agent Orchestrator (**AO**) runs AI coding agents in dedicated git worktrees and tracks each one until it becomes a pull request.
...
| ---------------------------------- | -------------------------------------------- |
| Creating separate workspaces       | Choosing good issues                         |

...
AO's core workflow is the same on every platform: create a separate workspace, run an agent, track the PR, react to CI and review events, and show progress in the dashboard.
